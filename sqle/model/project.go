...
// 	Managers   []*User      // TODO 移除 `gorm:"many2many:project_manager;"`
// 	Members    []*User      // TODO 移除 `gorm:"many2many:project_user;"`
// 	UserGroups []*UserGroup // TODO 移除 `gorm:"many2many:project_user_group;"`
...
// 		_, err = tx.Exec("INSERT INTO projects (`id`,`name`, `desc`, `create_user_id`,`workflow_template_id`) values (?, ?, ?, ?,?)", 700300 /*TODO DMS默认namespaceID 代码整合完毕后不会有project*/, name, desc, createUserID, templateID)
// 		if err != nil {
// 			return err
// 		}
