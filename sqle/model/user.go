...
LEFT JOIN users AS cur_ass_user ON cur_wst_re_user.user_id = cur_ass_user.id AND users.stat=0
...
LEFT JOIN users AS op_ass_user ON op_wst_re_user.user_id = op_ass_user.id AND users.stat=0
