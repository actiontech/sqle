...
var doc = `{
    ...
    "paths": {
        ...
        "/v1/tasks/audits/description/batch_update": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "operationId": "batchUpdateAuditTaskSQLDescV1",
                "parameters": [
                    {
                        "description": "batch modify the SQL description of audit tasks",
                        "name": "audit_plan",
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.BatchUpdateAuditTaskSQLDescReqV1"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "v1.BatchUpdateAuditTaskSQLDescReqV1": {
            "type": "object",
            "properties": {
                "update_audit_task_sql_desc_items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1.UpdateAuditTaskSQLDescItem"
                    }
                }
            }
        },
        ...
        "v1.UpdateAuditTaskSQLDescItem": {
            "type": "object",
            "properties": {
                "sql_descriptions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1.SQLDescription"
                    }
                },
                "task_id": {
                    "type": "string"
