...
var mockErr = errors.New("test err message")
...
func TestAsyncCallTimeoutNoCancel(t *testing.T) {
	cases := []struct {
		timeout          int
		elapsedFunc      int
		...
		{4, 3, mockErr, 4, mockErr},
		{4, 3, mockErr, 2, context.Canceled},
		{2, 3, mockErr, 4, context.DeadlineExceeded},
	}
