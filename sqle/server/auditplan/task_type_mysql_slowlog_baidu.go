...
func (at *MySQLSlowLogBaiduTaskV2) Metrics() []string {
	return []string{
		MetricNameCounter,
...
func (at *MySQLSlowLogBaiduTaskV2) mergeSQL(originSQL, mergedSQL *SQLV2) {
...
func (at *MySQLSlowLogBaiduTaskV2) AggregateSQL(cache SQLV2Cacher, sql *SQLV2) error {
...
func (at *MySQLSlowLogBaiduTaskV2) GetSQLs(ap *AuditPlan, persist *model.Storage, args map[string]interface{}) ([]Head, []map[string] /* head name */ string, uint64, error) {
