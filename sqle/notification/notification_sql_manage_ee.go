...
func (a *SQLmanageRecordNotification) NotificationBody() string {
	...
	if a.Config.SQLEUrl != "" && a.Config.ProjectName != "" {
		builder.WriteString(fmt.Sprintf("\n- SQL管控记录链接: %v/v2/projects/%v/sql_manages?filter_priority=hight&&filter_last_audit_start_time_from>%v&&filter_last_audit_start_time_to<%v", strings.TrimRight(a.Config.SQLEUrl, "/"), a.Config.ProjectName, a.Config.StartTime, a.Config.EndTime))
	}
