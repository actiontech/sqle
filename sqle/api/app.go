...
func StartApi(net *gracenet.Net, exitChan chan struct{}, config config.SqleConfig) {
	...
	// v1 admin api, just admin user can access.
	{
		...
		v1Router.PATCH("/configurations/webhook", v1.UpdateGlobalWorkflowWebHookConfig, AdminUserAllowed())
		v1Router.GET("/configurations/webhook", v1.GetGlobalWorkflowWebHookConfig, AdminUserAllowed())
		v1Router.POST("/configurations/webhook/test", v1.TestGlobalWorkflowWebHookConfig, AdminUserAllowed())
