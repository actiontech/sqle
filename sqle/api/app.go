...
func StartApi(net *gracenet.Net, exitChan chan struct{}, config *config.SqleOptions) {
...

	{
		...
		v2Router.GET("/tasks/audits/:task_id/files", v2.GetAuditTaskFileOverviewList)
		v2Router.GET("/tasks/audits/:task_id/files/:file_id/", v2.GetAuditTaskFileExecOverview)
