...
func StartApi(net *gracenet.Net, exitChan chan struct{}, config *config.SqleOptions, swaggerYaml []byte) {
	...
	// v1 admin api, just admin user can access.
	{
		...
		v1Router.PATCH("/configurations/coding_audit", v1.UpdateCodingAuditConfigurationV1, sqleMiddleware.OpGlobalAllowed())
		v1Router.GET("/configurations/coding_audit", v1.GetCodingAuditConfigurationV1, sqleMiddleware.ViewGlobalAllowed())
		v1Router.POST("/configurations/coding_audit/test", v1.TestCodingAuditConfigV1, sqleMiddleware.OpGlobalAllowed())
