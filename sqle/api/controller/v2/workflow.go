...
type WorkflowResV2 struct {
	...
	AssociationVersionStageWorkflows *AssociationVersionStageWorkflows `json:"association_version_stage_workflows,omitempty"`
}

type AssociationVersionStageWorkflows struct {
	WorkflowID        string `json:"workflow_id"`
