...
type BatchCreateAndAuditTasksWithTheSameSQLsReqV1 struct {
	Instances []*InstanceForCreatingTask `json:"instances" valid:"dive,required"`
	Sql       string                     `json:"sql" form:"sql"`
}

type BatchCreateAndAuditTasksWithTheSameSQLsResV1 struct {
	controller.BaseRes
	Data []*AuditTaskResV1 `json:"data"`
}

// CreateAndAuditTasksWithTheSameSQLsV1
...
// @Produce json
// @Tags task
// @Id createAndAuditTaskWithTheSameSQLsV1
// @Security ApiKeyAuth
// @Param req body v1.BatchCreateAndAuditTasksWithTheSameSQLsReqV1 true "parameters for creating and audit tasks"
// @Param input_sql_file formData file false "input SQL file"
// @Param input_mybatis_xml_file formData file false "input mybatis XML file"
// @Success 200 {object} v1.BatchCreateAndAuditTasksWithTheSameSQLsResV1
// @router /v1/tasks/same_sqls_audits [post]
func CreateAndAuditTasksWithTheSameSQLsV1(c echo.Context) error {
	return nil
}
