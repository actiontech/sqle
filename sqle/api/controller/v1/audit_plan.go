...
type AuditPlanReportResV1 struct {
	...
	Timestamp string `json:"audit_plan_report_timestamp" example:"RFC3399"`
}
...
type AuditPlanReportDetailResV1 struct {
	...
	AuditResult        string `json:"audit_plan_report_audit_results" example:"same format as task audit result"`
	Timestamp          string `json:"audit_plan_report_timestamp" example:"RFC3399"`
}
...
type AuditPlanSQLReqV1 struct {
	...
	SQLLastReceiveTimestamp string `json:"audit_plan_sql_last_receive_timestamp" form:"audit_plan_sql_last_receive_timestamp" example:"RFC3399"`
}
...
type AuditPlanSQLResV1 struct {
	...
	SQLLastReceiveTimestamp string `json:"audit_plan_sql_last_receive_timestamp" example:"RFC3399"`
}
