...
type InstanceTipReqV1 struct {
	...
	FunctionalModule         string `json:"functional_module" query:"functional_module" enums:"create_audit_plan,sql_query" valid:"omitempty,oneof=create_audit_plan sql_query create_audit_workflow"`
}
...
// @Param functional_module query string false "functional module" Enums(create_audit_plan,sql_query,create_audit_workflow)
