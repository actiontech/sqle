...
type DriverClient interface {
	...
	// Parse SQL from sql file, simulating the parsing method used by database clients before executing SQL files. Different database clients have different implementation methods. For example, MySQL clients can customize delimiters, while Oracle clients use / to determine the end of the SQL statement block for "begin ... end;"
	ParseSimulateClient(ctx context.Context, in *ParseRequest, opts ...grpc.CallOption) (*ParseResponse, error)
	// db audit
...
func (c *driverClient) ParseSimulateClient(ctx context.Context, in *ParseRequest, opts ...grpc.CallOption) (*ParseResponse, error) {
	out := new(ParseResponse)
	err := grpc.Invoke(ctx, "/protoV2.Driver/ParseSimulateClient", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DriverServer interface {
	...
	// Parse SQL from sql file, simulating the parsing method used by database clients before executing SQL files. Different database clients have different implementation methods. For example, MySQL clients can customize delimiters, while Oracle clients use / to determine the end of the SQL statement block for "begin ... end;"
	ParseSimulateClient(context.Context, *ParseRequest) (*ParseResponse, error)
	// db audit
...
func _Driver_ParseSimulateClient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ParseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DriverServer).ParseSimulateClient(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protoV2.Driver/ParseSimulateClient",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DriverServer).ParseSimulateClient(ctx, req.(*ParseRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Driver_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ParseSimulateClient",
			Handler:    _Driver_ParseSimulateClient_Handler,
		},
		{
			MethodName: "Parse",
...
var fileDescriptor0 = []byte{
	...
	,
}
