...
const (
	...
	OptionalModule_Provision             OptionalModule = 7
)
...
const (
	SQLOp_AddOrUpdate SQLOp = 0
	SQLOp_Read        SQLOp = 1
	SQLOp_Delete      SQLOp = 2
	SQLOp_Grant       SQLOp = 3
	SQLOp_Admin       SQLOp = 4
)
...
func (SQLOp) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }

// GetSQLOp
type SQLObjectType int32

const (
	SQLObjectType_SQLObjectTypeTable    SQLObjectType = 0
	SQLObjectType_SQLObjectTypeDatabase SQLObjectType = 1
	SQLObjectType_SQLObjectTypeSchema   SQLObjectType = 2
	SQLObjectType_SQLObjectTypeInstance SQLObjectType = 3
	SQLObjectType_SQLObjectTypeServer   SQLObjectType = 4
)

var SQLObjectType_name = map[int32]string{
	0: "SQLObjectTypeTable",
	1: "SQLObjectTypeDatabase",
	2: "SQLObjectTypeSchema",
	3: "SQLObjectTypeInstance",
	4: "SQLObjectTypeServer",
}
var SQLObjectType_value = map[string]int32{
	"SQLObjectTypeTable":    0,
	"SQLObjectTypeDatabase": 1,
	"SQLObjectTypeSchema":   2,
	"SQLObjectTypeInstance": 3,
	"SQLObjectTypeServer":   4,
}

func (x SQLObjectType) String() string {
	return proto.EnumName(SQLObjectType_name, int32(x))
}
func (SQLObjectType) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
type SQLObject struct {
	Type         SQLObjectType `protobuf:"varint,1,opt,name=type,enum=protoV2.SQLObjectType" json:"type,omitempty"`
	DatabaseName string        `protobuf:"bytes,2,opt,name=databaseName" json:"databaseName,omitempty"`
...
func (m *SQLObject) Reset()                    { *m = SQLObject{} }
func (m *SQLObject) String() string            { return proto.CompactTextString(m) }
func (*SQLObject) ProtoMessage()               {}
func (*SQLObject) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{60} }

func (m *SQLObject) GetType() SQLObjectType {
	if m != nil {
		return m.Type
	}
	return SQLObjectType_SQLObjectTypeTable
}

func (m *SQLObject) GetDatabaseName() string {
	if m != nil {
...
func (m *SQLObject) GetSchemaName() string {
	if m != nil {
		return m.SchemaName
	}
	return ""
...
func (m *SQLObject) GetTableName() string {
	if m != nil {
		return m.TableName
	}
	return ""
...
type SQLObjectOp struct {
	Op     SQLOp      `protobuf:"varint,1,opt,name=op,enum=protoV2.SQLOp" json:"op,omitempty"`
	Object *SQLObject `protobuf:"bytes,2,opt,name=object" json:"object,omitempty"`
}

func (m *SQLObjectOp) Reset()                    { *m = SQLObjectOp{} }
func (m *SQLObjectOp) String() string            { return proto.CompactTextString(m) }
func (*SQLObjectOp) ProtoMessage()               {}
func (*SQLObjectOp) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{61} }

func (m *SQLObjectOp) GetOp() SQLOp {
	if m != nil {
		return m.Op
	}
	return SQLOp_AddOrUpdate
}

func (m *SQLObjectOp) GetObject() *SQLObject {
	if m != nil {
		return m.Object
	}
	return nil
...
// GetSQLOp
type GetSQLOpSQL struct {
	Sql string `protobuf:"bytes,1,opt,name=sql" json:"sql,omitempty"`
}

func (m *GetSQLOpSQL) Reset()                    { *m = GetSQLOpSQL{} }
func (m *GetSQLOpSQL) String() string            { return proto.CompactTextString(m) }
func (*GetSQLOpSQL) ProtoMessage()               {}
func (*GetSQLOpSQL) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{62} }

func (m *GetSQLOpSQL) GetSql() string {
	if m != nil {
		return m.Sql
	}
	return ""
...
// GetSQLOp
type GetSQLOpSQLInfo struct {
	Sql string `protobuf:"bytes,1,opt,name=sql" json:"sql,omitempty"`
}

func (m *GetSQLOpSQLInfo) Reset()                    { *m = GetSQLOpSQLInfo{} }
func (m *GetSQLOpSQLInfo) String() string            { return proto.CompactTextString(m) }
func (*GetSQLOpSQLInfo) ProtoMessage()               {}
func (*GetSQLOpSQLInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{63} }

func (m *GetSQLOpSQLInfo) GetSql() string {
	if m != nil {
		return m.Sql
	}
	return ""
...
// GetSQLOp
type SQLOps struct {
	ObjectOps []*SQLObjectOp   `protobuf:"bytes,1,rep,name=objectOps" json:"objectOps,omitempty"`
	Sql       *GetSQLOpSQLInfo `protobuf:"bytes,2,opt,name=sql" json:"sql,omitempty"`
}

func (m *SQLOps) Reset()                    { *m = SQLOps{} }
func (m *SQLOps) String() string            { return proto.CompactTextString(m) }
func (*SQLOps) ProtoMessage()               {}
func (*SQLOps) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{64} }

func (m *SQLOps) GetObjectOps() []*SQLObjectOp {
	if m != nil {
		return m.ObjectOps
	}
	return nil
...
func (m *SQLOps) GetSql() *GetSQLOpSQLInfo {
	if m != nil {
		return m.Sql
	}
	return nil
...
type GetSQLOpRequest struct {
	Session *Session     `protobuf:"bytes,1,opt,name=session" json:"session,omitempty"`
	SqlText *GetSQLOpSQL `protobuf:"bytes,2,opt,name=sqlText" json:"sqlText,omitempty"`
}

func (m *GetSQLOpRequest) Reset()                    { *m = GetSQLOpRequest{} }
func (m *GetSQLOpRequest) String() string            { return proto.CompactTextString(m) }
func (*GetSQLOpRequest) ProtoMessage()               {}
func (*GetSQLOpRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{65} }

func (m *GetSQLOpRequest) GetSession() *Session {
	if m != nil {
		return m.Session
	}
	return nil
...
func (m *GetSQLOpRequest) GetSqlText() *GetSQLOpSQL {
	if m != nil {
		return m.SqlText
	}
	return nil
...
type GetSQLOpResponse struct {
	SqlOps []*SQLOps `protobuf:"bytes,1,rep,name=sqlOps" json:"sqlOps,omitempty"`
}

func (m *GetSQLOpResponse) Reset()                    { *m = GetSQLOpResponse{} }
func (m *GetSQLOpResponse) String() string            { return proto.CompactTextString(m) }
func (*GetSQLOpResponse) ProtoMessage()               {}
func (*GetSQLOpResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{66} }

func (m *GetSQLOpResponse) GetSqlOps() []*SQLOps {
	if m != nil {
		return m.SqlOps
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*SQLObject)(nil), "protoV2.SQLObject")
	proto.RegisterType((*SQLObjectOp)(nil), "protoV2.SQLObjectOp")
	proto.RegisterType((*GetSQLOpSQL)(nil), "protoV2.GetSQLOpSQL")
	proto.RegisterType((*GetSQLOpSQLInfo)(nil), "protoV2.GetSQLOpSQLInfo")
	proto.RegisterType((*SQLOps)(nil), "protoV2.SQLOps")
	proto.RegisterType((*GetSQLOpRequest)(nil), "protoV2.GetSQLOpRequest")
	proto.RegisterType((*GetSQLOpResponse)(nil), "protoV2.GetSQLOpResponse")
	proto.RegisterEnum("protoV2.OptionalModule", OptionalModule_name, OptionalModule_value)
	proto.RegisterEnum("protoV2.SQLOp", SQLOp_name, SQLOp_value)
	proto.RegisterEnum("protoV2.SQLObjectType", SQLObjectType_name, SQLObjectType_value)
}
...
type DriverClient interface {
	...
	// provision
	GetSQLOp(ctx context.Context, in *GetSQLOpRequest, opts ...grpc.CallOption) (*GetSQLOpResponse, error)
}
...
func (c *driverClient) GetSQLOp(ctx context.Context, in *GetSQLOpRequest, opts ...grpc.CallOption) (*GetSQLOpResponse, error) {
	out := new(GetSQLOpResponse)
	err := grpc.Invoke(ctx, "/protoV2.Driver/GetSQLOp", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DriverServer interface {
	...
	// provision
	GetSQLOp(context.Context, *GetSQLOpRequest) (*GetSQLOpResponse, error)
}
...
func _Driver_GetSQLOp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSQLOpRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DriverServer).GetSQLOp(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protoV2.Driver/GetSQLOp",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DriverServer).GetSQLOp(ctx, req.(*GetSQLOpRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Driver_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetSQLOp",
			Handler:    _Driver_GetSQLOp_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
