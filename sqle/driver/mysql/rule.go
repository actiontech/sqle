...
var RuleHandlers = []RuleHandler{
	// config
	{
		Rule: model.Rule{
			...
			Typ:       model.RuleTypeGlobalConfig,
			IsDefault: true,
		},
		Func: nil,
	},
	...
	// rule
	{
		Rule: model.Rule{
			...
			Typ:       model.RuleTypeUsageSuggestion,
			IsDefault: true,
		},
	...
	},
	{
		Rule: model.Rule{
			...
			Level:     model.RuleLevelError,
			Typ:       model.RuleTypeNamingConvention,
			IsDefault: true,
		},
	...
	},
	{
		Rule: model.Rule{
			...
			Desc:      "表必须有主键",
			Level:     model.RuleLevelError,
			Typ:       model.RuleTypeIndexingConvention,
			IsDefault: true,
		},
		Message:              "表必须有主键",
		AllowOffline:         true,
	...
	},
	{
		Rule: model.Rule{
			...
			Level:     model.RuleLevelError,
			Typ:       model.RuleTypeDDLConvention,
			IsDefault: true,
		},
	...
	},
	{
		Rule: model.Rule{
			...
			Level:     model.RuleLevelError,
			Typ:       model.RuleTypeDMLConvention,
			IsDefault: true,
		},
