...
func (t *testResult) addResult(ruleName string, args ...interface{}) *testResult {
	...
	if handler.Message != nil {
		m = plocale.ShouldLocalizeMsgByLang(language.English, handler.Message)
	}
...
func TestCheckInvalidUse(t *testing.T) {
	runDefaultRulesInspectCase(t, "use_database: database not exist", DefaultMysqlInspect(),
		"use no_exist_db",
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.SchemaNotExistMessage), "no_exist_db"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.TableNotExistMessage), "exist_db.EXIST_TB_1").
...
func TestDDLCheckTableSize(t *testing.T) {
	...
	runSingleRuleInspectCase(rule, t, "alter_table: table4 oversized", DefaultMysqlInspect(),
		`alter table exist_db.exist_tb_4;`, newTestResult().addResult(rulepkg.DDLCheckTableSize, "exist_tb_4", 16).addResult(rulepkg.ConfigDDLOSCMinSize, plocale.ShouldLocalizeMsgByLang(language.English, plocale.PTOSCNoUniqueIndexOrPrimaryKey)))
...
`,
		newTestResult().addResult(rulepkg.DDLCheckPKName).add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.SchemaNotExistMessage), "not_exist_db"),
	)
...
`,
		newTestResult().addResult(rulepkg.DDLCheckPKName).add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.TableExistMessage), "exist_db.exist_tb_1"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.TableNotExistMessage), "exist_db.not_exist_tb_2"),
	)
...
`,
		newTestResult().addResult(rulepkg.DDLCheckPKName).add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.MultiPrimaryKeyMessage)))
...
`,
		newTestResult().addResult(rulepkg.DDLCheckPKName).add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.DuplicateColumnsMessage),
			"v1"))
...
`,
		newTestResult().addResult(rulepkg.DDLCheckPKName).add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.DuplicateIndexesMessage),
			"idx_1"))
...
`,
		newTestResult().addResult(rulepkg.DDLCheckPKName).add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.KeyedColumnNotExistMessage),
...
`,
		newTestResult().addResult(rulepkg.DDLCheckPKName).add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.DuplicatePrimaryKeyedColumnMessage), "id"))
...
`,
		newTestResult().addResult(rulepkg.DDLCheckPKName).add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.DuplicateIndexedColumnMessage), "idx_1",
			"v1"))
...
`,
		newTestResult().addResult(rulepkg.DDLCheckPKName).add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.DuplicateIndexedColumnMessage), "(匿名)",
...
`,
		newTestResult().addResult(rulepkg.DDLCheckPKName).add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.DuplicateIndexedColumnMessage), "idx_1", "v1").
			add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.DuplicateIndexedColumnMessage), "idx_2", "v2"))
}
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.SchemaNotExistMessage),
			"not_exist_db"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.TableNotExistMessage),
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.ColumnExistMessage), "v1"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.ColumnNotExistMessage),
			"v5"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.ColumnExistMessage),
			"v1"),
	)
...
`,
		newTestResult().addResult(rulepkg.DDLCheckPKName).
			add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.PrimaryKeyExistMessage)).
...
`,
		newTestResult().addResult(rulepkg.DDLCheckPKName).add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.KeyedColumnNotExistMessage), "id11").addResult(rulepkg.DDLCheckIndexNotNullConstraint, "id11"),
	)
...
`,
		newTestResult().addResult(rulepkg.DDLCheckPKName).add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.DuplicatePrimaryKeyedColumnMessage),
			"id"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.IndexExistMessage), "idx_1"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.IndexNotExistMessage), "idx_2"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.KeyedColumnNotExistMessage), "v3").addResult(rulepkg.DDLCheckIndexNotNullConstraint, "v3"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.DuplicateIndexedColumnMessage), "idx_2",
			"id"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.DuplicateIndexedColumnMessage), "(匿名)",
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.SchemaExistMessage), "exist_db"),
	)
}
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.SchemaNotExistMessage), "not_exist_db").addResult(rulepkg.DDLCheckIndexNotNullConstraint, "v1"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.TableNotExistMessage), "exist_db.not_exist_tb").addResult(rulepkg.DDLCheckIndexNotNullConstraint, "v1"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.DuplicateIndexedColumnMessage), "idx_2", "id"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.SchemaNotExistMessage), "not_exist_db"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.TableNotExistMessage), "exist_db.not_exist_tb"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.ColumnNotExistMessage), "v3"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.DuplicateColumnsMessage), "v1"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.ColumnsValuesNotMatchMessage)),
	)
}
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.ColumnNotExistMessage), "t.v3"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.ColumnNotExistMessage), "exist_tb_1.v1"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.ColumnNotExistMessage), "exist_tb_1.v3"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.ColumnNotExistMessage), "exist_tb_2.v3"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.ColumnNotExistMessage), "exist_tb_1.v3,exist_tb_2.v3").
			addResult(rulepkg.DMLCheckJoinFieldUseIndex),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.ColumnNotExistMessage), "exist_tb_3.v1").
			addResult(rulepkg.DMLCheckJoinFieldUseIndex),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.ColumnNotExistMessage), "not_exist_db.exist_tb_1.v1").
			addResult(rulepkg.DMLCheckJoinFieldUseIndex),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.ColumnIsAmbiguousMessage), "v1"),
	)
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.ColumnIsAmbiguousMessage), "v1").addResult(rulepkg.DMLCheckHasJoinCondition),
	)
}
...
`,
		newTestResult().add(driverV2.RuleLevelError, "", plocale.ShouldLocalizeMsgByLang(language.English, plocale.ColumnNotExistMessage), "exist_tb_2.id"),
	)
}
...
func Test_LowerCaseTableNameOpen(t *testing.T) {
	...
	// check use
	{
		runEmptyRuleInspectCase(t, "test lower case table name open 1-1", getLowerCaseOpenInspect(),
			...
			newTestResult().add(driverV2.RuleLevelError, "",
				plocale.ShouldLocalizeMsgByLang(language.English, plocale.SchemaNotExistMessage), "not_exist_db"))
	...
	// check schema
	{
		runEmptyRuleInspectCase(t, "test lower case table name open 2-1", getLowerCaseOpenInspect(),
			`create database EXIST_DB;`,
			newTestResult().add(driverV2.RuleLevelError, "",
				plocale.ShouldLocalizeMsgByLang(language.English, plocale.SchemaExistMessage), "EXIST_DB"))
...
create database NOT_EXIST_DB;`,
			newTestResult(),
			newTestResult().add(driverV2.RuleLevelError, "",
				plocale.ShouldLocalizeMsgByLang(language.English, plocale.SchemaExistMessage), "NOT_EXIST_DB"))
...
create database not_exist_db;`,
	...
	// check table
	{
		runEmptyRuleInspectCase(t, "test lower case table name open 3-1", getLowerCaseOpenInspect(),
			...
			newTestResult().add(driverV2.RuleLevelError, "",
				plocale.ShouldLocalizeMsgByLang(language.English, plocale.TableExistMessage), "EXIST_DB.exist_tb_1"))
...
create table EXIST_DB.exist_tb_2 (id int);`,
			newTestResult(),
			newTestResult().add(driverV2.RuleLevelError, "",
				plocale.ShouldLocalizeMsgByLang(language.English, plocale.TableExistMessage), "EXIST_DB.exist_tb_2"))
...
`,
			newTestResult(),
			newTestResult().add(driverV2.RuleLevelError, "",
				plocale.ShouldLocalizeMsgByLang(language.English, plocale.TableNotExistMessage), "exist_db.EXIST_TB_1"))
...
`,
	...
	// check dml
	{
		runEmptyRuleInspectCase(t, "test lower case table name open 4-1", getLowerCaseOpenInspect(),
			...
			newTestResult().add(driverV2.RuleLevelError, "",
				plocale.ShouldLocalizeMsgByLang(language.English, plocale.TableNotExistMessage), "exist_db.EXIST_TB_2"))
...
func Test_LowerCaseTableNameClose(t *testing.T) {
	...
	// check use
	{
		...
		runEmptyRuleInspectCase(t, "test lower case table name close 1-4", getLowerCaseCloseInspect(),
			`use EXIST_DB_1;`,
			newTestResult().add(driverV2.RuleLevelError, "",
				plocale.ShouldLocalizeMsgByLang(language.English, plocale.SchemaNotExistMessage), "EXIST_DB_1"))
		...
		runEmptyRuleInspectCase(t, "test lower case table name close 1-7", getLowerCaseCloseInspect(),
			`use exist_db_2;`,
			newTestResult().add(driverV2.RuleLevelError, "",
				plocale.ShouldLocalizeMsgByLang(language.English, plocale.SchemaNotExistMessage), "exist_db_2"))
	}
	// check schema
	{
		runEmptyRuleInspectCase(t, "test lower case table name close 2-1", getLowerCaseCloseInspect(),
			...
			newTestResult().add(driverV2.RuleLevelError, "",
				plocale.ShouldLocalizeMsgByLang(language.English, plocale.SchemaExistMessage), "exist_db_1"))
...
create database NOT_EXIST_DB;`,
	...
	// check table
	{
		runEmptyRuleInspectCase(t, "test lower case table name close 3-1", getLowerCaseCloseInspect(),
			...
			newTestResult().add(driverV2.RuleLevelError, "",
				plocale.ShouldLocalizeMsgByLang(language.English, plocale.TableExistMessage), "exist_db_1.exist_tb_1"))
...
`,
			newTestResult().add(driverV2.RuleLevelError, "",
				plocale.ShouldLocalizeMsgByLang(language.English, plocale.TableNotExistMessage), "exist_db_1.EXIST_TB_1"))
...
`,
			newTestResult(),
			newTestResult().add(driverV2.RuleLevelError, "",
				plocale.ShouldLocalizeMsgByLang(language.English, plocale.TableNotExistMessage), "exist_db_1.EXIST_TB_2"))
	}
}
...
func TestMustMatchLeftMostPrefix(t *testing.T) {
	...
	for _, arg := range args {
		...
		t.Run(arg.Name, func(t *testing.T) {
			res := newTestResult()
			if arg.TriggerRule {
				res = newTestResult().add(rule.Level, rule.Name, plocale.ShouldLocalizeMsgByLang(language.English, rulepkg.RuleHandlerMap[rulepkg.DMLMustMatchLeftMostPrefix].Message))
			}
...
func TestMustUseLeftMostPrefix(t *testing.T) {
	...
	for _, arg := range args {
		...
		t.Run(arg.Name, func(t *testing.T) {
			res := newTestResult()
			if arg.TriggerRule {
				res = newTestResult().add(rule.Level, rule.Name, plocale.ShouldLocalizeMsgByLang(language.English, rulepkg.RuleHandlerMap[rulepkg.DMLMustUseLeftMostPrefix].Message))
			}
...
func TestDDLCheckCharLength(t *testing.T) {
	...
	for _, arg := range args {
		...
		t.Run(arg.Name, func(t *testing.T) {
			res := newTestResult()
			if arg.TriggerRule {
				res = newTestResult().add(rule.Level, rule.Name, plocale.ShouldLocalizeMsgByLang(language.English, rulepkg.RuleHandlerMap[rulepkg.DDLCheckCharLength].Message), arg.Param)
			}
