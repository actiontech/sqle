...
require (
	actiontech.cloud/universe/ucommon/v3 v3.2006.1-0.20200910104953-742fa12acee4
	actiontech.cloud/universe/ucore-common/v3 v3.0.0-20200914025644-05f3c4e3ce7e
