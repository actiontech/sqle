...
require (
	actiontech.cloud/universe/ucommon/v4 v4.2101.1-0.20210128025016-786c01958eb4
	actiontech.cloud/universe/ucore-common/v4 v4.0.0-20210128230656-fa0326a6789b
