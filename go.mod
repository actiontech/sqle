...
require (
	actiontech.cloud/universe/ucommon/v4 v4.2011.1-0.20201218062633-dde2d6b8e9f4
	actiontech.cloud/universe/ucore-common/v4 v4.0.0-20201221025904-61d006e22cf7
