...
require (
	actiontech.cloud/universe/ucommon/v4 v4.2011.1-0.20201130023048-056dd16a1cf3
	actiontech.cloud/universe/ucore-common/v4 v4.0.0-20201201023630-551496c6552d
