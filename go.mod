...
require (
	actiontech.cloud/universe/ucommon/v4 v4.2011.1-0.20210119101905-a33e10c8ef72
	actiontech.cloud/universe/ucore-common/v4 v4.0.0-20210119104946-280ac8b12b52
