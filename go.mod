...
require (
	actiontech.cloud/universe/ucommon/v4 v4.2011.1-0.20210114050200-fa805a969c07
	actiontech.cloud/universe/ucore-common/v4 v4.0.0-20210115230805-57e7bd4ba674
